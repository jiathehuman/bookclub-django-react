...
function ResetPassword() {
  ...
  const SubmitEmailHandler = async (event) => {
    ...
    setIsLoading(true);
    try {
      await apiInstance.get(`user/reset-password/${email}`).then((response) => {
        console.log(response.data);
        setIsLoading(false);
        alert("Password reset is sent")
      });
    } catch (error) {
          ...
          <div className="col-lg-5 col-md-8 py-8 py-xl-0">
            <div className="card shadow">
              <div className="card-body p-6">
                ...
                <form className="needs-validation" noValidate="" onSubmit={SubmitEmailHandler}>
                  <div className="mb-3">
